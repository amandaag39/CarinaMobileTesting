...
@DeviceType(pageType = DeviceType.Type.ANDROID_PHONE, parentClass = CalculatorInterfaceBase.class)
public class CalculatorInterface extends CalculatorInterfaceBase {
    ...
    public CalculatorInterface(WebDriver driver) {
        super(driver);
    }
